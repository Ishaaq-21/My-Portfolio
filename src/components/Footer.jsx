...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-slate-800 py-12 lg:py-16">
          ...
          {sectionNames.map((name) => {
            return (
              <li>
                <a
                  href={`#${name}`}
                  className="text-sm md:text-lg font-semibold text-subTitle dark:text-zinc-100/80 dark:hover:text-primary hover:text-primary transition duration-300"
                >
                  {name}
                </a>
              </li>
          ...
          {socialLinks.map((socialAcc) => {
            return (
              <li>
                <a
                  href={socialAcc.href}
                  className={`text-4xl text-subTitle dark:text-zinc-100/80 transition duration-300 ${socialAcc.hoverColor} ${socialAcc.darkHoverColor}`}
                  target="_blank"
